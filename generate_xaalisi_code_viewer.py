...
# Base directory for the XAALISI site
base_dir = r"c:\Users\Applag\OneDrive - um5.ac.ma\Desktop\portfolio\public\projects\xaalisi\code"
output_file = r"c:\Users\Applag\OneDrive - um5.ac.ma\Desktop\portfolio\public\projects\xaalisi\code.html"

# Extensions to include
allowed_exts = ('.ts', '.tsx', '.js', '.jsx', '.css', '.html', '.json', '.mjs', '.yaml', '.py', '.md', '.env.example')
...
<head>
  ...
  <title>XAALISI - Source Code Viewer</title>
...
html_bottom = """
  ...
  <script>
    const basePath = '/projects/xaalisi/code/';
    ...
    document.querySelectorAll('.file-item').forEach(item => {
      item.addEventListener('click', async () => {
        ...
        else if(file.endsWith('.md')) lang = 'markdown';
...
print("Generated code.html for XAALISI!")
