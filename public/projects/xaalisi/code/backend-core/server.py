...
app.include_router(tontine_router.router)
app.include_router(ussd_router.router)
app.include_router(wallet_router.router)
app.include_router(sms_router.router, prefix="/sms", tags=["SMS Banking"])
app.include_router(banking_router.router, prefix="/digital-banking", tags=["Digital Banking"])
app.include_router(merchant_router.router, prefix="/merchants", tags=["SoftPOS & Merchants"])
app.include_router(workflow_router.router, prefix="/workflows", tags=["Approvals & Workflows"])
app.include_router(open_banking_router.router, prefix="/open-banking", tags=["Open Banking B2B"])
app.include_router(integrations_router.router, prefix="/integrations", tags=["Intégrations Tierces"])
...
app.include_router(commission_engine_router.router, prefix="/engine", tags=["Commission Engine"])
app.include_router(api_analytics_router.router)
app.include_router(notifications_router.router)
app.include_router(kyc_router.router)
app.include_router(kyc_ocr_router.router, prefix="/ged", tags=["GED, OCR & Signature"])
app.include_router(regulatory_router.router, prefix="/regulatory", tags=["Conformité & Reporting"])
app.include_router(cheques_router.router, prefix="/cheques", tags=["Chèques"])
app.include_router(ai_bot_router.router, prefix="/ai", tags=["Assistant IA"])
app.include_router(cbs_integration_router.router, prefix="/cbs", tags=["CBS & ISO 20022"])
